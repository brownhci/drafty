...
const stmtInsertDelRow: string = 'INSERT INTO Edit_DelRow (idEdit, idUniqueID, comment) VALUES (?, ?, ?)';
...
*
***/
export async function deactivateRow(idEdit: number, idUniqueID: string, comment: string) {
  try {
