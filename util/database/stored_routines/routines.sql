create
    definer = root@localhost function get_idSuggestionType(idSuggestion_var int) returns int
BEGIN
...
create
    definer = root@localhost function get_idUniqueID(idSuggestion_var int) returns int
BEGIN
...
create
    definer = root@localhost procedure insert_edit_suggestions(IN idSuggestionPrev_var int,
                                                               IN idSuggestionChosen_var int, IN idSession_var int,
                                                               IN idInteractionType_var int, IN idEntryType_var int,
                                                               IN mode_var varchar(25), IN idProfile_var int)
BEGIN
...
create
    definer = root@localhost function insert_interaction(idSession_var int, idInteractionType_var int) returns int
BEGIN
...
create
    definer = root@localhost procedure new_edit(IN idSuggestion_var int, IN suggestion_var varchar(1000),
...
create
    definer = root@localhost procedure new_suggestion_new_row(IN suggestion_var varchar(1000), IN idEdit_var int,
                                                              IN idProfile_var int, IN idSuggestionType_var int,
                                                              IN idUniqueId_var int, OUT idSuggestion_new int)
BEGIN
...
create
    definer = root@localhost procedure new_suggestion(INOUT idSuggestion_var int, IN suggestion_var varchar(1000),
...
create
    definer = root@localhost procedure new_user_credit_suggestion_new_row(IN idProfile_var int, IN idUniqueId_var int)
BEGIN
    DECLARE confidence_var INT DEFAULT 1;
