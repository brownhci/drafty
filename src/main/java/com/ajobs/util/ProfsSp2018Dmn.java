...
public class ProfsSp2018Dmn {
	
	private String matched_idUniqueID;
	private String id;
	...
	public String getMatched_idUniqueID() {
		return matched_idUniqueID;
	}

	public void setMatched_idUniqueID(String matched_idUniqueID) {
		this.matched_idUniqueID = matched_idUniqueID;
	}
